...
// -Usage: Check if specific reset_Key[#] or randomzier_Key[#] array is 'true', run reset() function and set
//  specific reset_Key[#] or randomizer_Key array to 'false' to prevent reset() function from looping again
